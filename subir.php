...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <span id="logo"><a href="usuario.php"><img id="logo" href="usuario.php" src="imagenes/logo.ico" width="50" height="50" ></a></span>
    ...
    <div class="container-login100">
      <div class="wrap-login100 p-t-20 p-b-40">
        <form id="form3" action="cargar.php" method="POST" enctype="multipart/form-data">
          <center><span >
            Subir trabajo
          </span></center><br><br>
